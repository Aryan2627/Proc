        ...
        >
          ...
          <div className="relative aspect-video rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_100px_rgba(37,99,235,0.2)] bg-[#050505] group">
            ...
            <div className="absolute bottom-4 left-4 z-30 bg-black/60 backdrop-blur-md border border-white/10 px-4 py-2 rounded-lg">
              <p className="text-xs text-zinc-300 font-mono"><span className="text-emerald-400">► Note:</span> Upload your generated .mp4 video to a CDN and swap this URL!</p>
            </div>
          </div>
        </motion.div>
...
code = code.replace("{/* --- MEGA FEATURES GRID --- */}", videoComponent);

fs.writeFileSync('src/app/page.tsx', code, 'utf8');
console.log("Injected video section before Mega Features Grid.");
