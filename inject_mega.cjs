...
// 1. Add extra Lucide icons needed for the massive enterprise layout
page = page.replace(
...
// 2. Replace the static logo strip with an animated Marquee (Atlan style)
const logoMarquee = `
...
// 3. Inject new massive sections: Integrations, G2 Social Proof, and Bottom CTA
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative w-full max-w-5xl mx-auto h-[400px] flex items-center justify-center">
            ...
            <svg className="absolute inset-0 w-full h-full z-10" style={{ filter: 'drop-shadow(0px 0px 4px rgba(37,99,235,0.3))' }}>
              <path d="M 500 200 Q 250 100 150 100" fill="none" stroke="#E2E8F0" strokeWidth="2" strokeDasharray="6 6" className="animate-[dash_3s_linear_infinite]" />
...
console.log('Injected mega enterprise sections.');
