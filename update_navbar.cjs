      ...
      <section id="features" className="py-32 relative z-10">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: FileText, title: "Intake Requests", desc: "Multi-level approvals handled instantly. Say goodbye to emails.", color: "group-hover:border-violet-500 group-hover:shadow-[0_0_30px_rgba(139,92,246,0.15)]" },
              { icon: Gavel, title: "Reverse Auctions", desc: "Suppliers bid live. Watch your procurement costs drop in real-time.", color: "group-hover:border-fuchsia-500 group-hover:shadow-[0_0_30px_rgba(217,70,239,0.15)]" },
