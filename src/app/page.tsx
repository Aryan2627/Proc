...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-blue-500/30 overflow-hidden relative">
      ...
      {/* ─── CORTEX AI SECTION ─────────────────────────────────────────────── */}
      <section id="cortex" className="py-24 relative bg-slate-900 text-white overflow-hidden border-y border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start relative pb-32">
            ...
            <div className="w-full md:w-2/3 flex flex-col gap-12 relative pb-40">
              {[
